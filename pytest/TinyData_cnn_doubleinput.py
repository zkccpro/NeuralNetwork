...
def ut_TinyData_cnn_doubleinput():
    ...
    # 2w张图片，训练时稳定占用25G内存
    pic_list, test_list, label, test_label = dataReader.PredictDataReader([r"data/TinyData/", r"data/DiffPic/"], None).read(50,42)
    ...
    action.train(cnn, dataloader, testloader,
                globalParam.secnn_doubleinput_optimizer, reg_inferencer,
