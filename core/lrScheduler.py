...
class WarmupLR(CosineAnnealingLR):
    def __init__(self, optimizer, T_max=100, eta_min=1.0e-5, last_epoch=-1, verbose=False,
                 warmup_steps=1000, warmup_start_lr=1.0e-6):
    ...
    def get_lr(self):
        if not self._get_lr_called_within_step:
            print("WARNING: To get the last learning rate computed by the scheduler, please use `get_last_lr()`")
